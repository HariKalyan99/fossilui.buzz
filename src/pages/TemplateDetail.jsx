      ...
      <section className="container-page py-6 md:py-8">
        ...
        <div className="grid gap-6">
          ...
          <motion.div
            ...
            className={cn(
              'template-code-workbench card overflow-hidden flex flex-col h-[640px] !bg-[#221a0f] !border-[#51412c]',
              view === 'preview' && 'hidden md:flex',
            )}
          >
            {/* Toolbar */}
            <div className="flex items-center justify-between border-b border-[#51412c] px-2 py-1.5 bg-[#221a0f]">
              <div className="flex items-center gap-1 min-w-0">
                <button
                  type="button"
                  onClick={() => setSidebarOpen((v) => !v)}
                  className="inline-flex h-7 w-7 items-center justify-center rounded-md text-[#a57a4c] hover:text-[#e3b583] hover:bg-[#5e452b]/60"
                ...
                <span className="text-[12.5px] text-[#d3af86] px-2 truncate font-mono">
                  {active?.path || '—'}
                </span>
              </div>
              <div className="flex items-center gap-1 shrink-0">
                <span className="hidden sm:inline-flex items-center gap-1 text-[10.5px] uppercase tracking-[0.16em] text-[#a57a4c] px-2">
                  {active?.lang || 'text'}
                </span>
                <button
                  type="button"
                  ...
                  className={cn(
                    ...
                    copied
                      ? 'border-[#889b4a]/40 text-[#889b4a] bg-[#889b4a]/10'
                      : 'border-[#51412c] text-[#d3af86] hover:bg-[#5e452b]/60',
                  )}
                >
                  {copied ? (
                    <>
            ...
            <div className="flex flex-1 min-h-0 bg-[#221a0f]">
              <div className="sm:hidden flex-1 min-w-0 overflow-hidden bg-[#221a0f]" data-lenis-prevent>
                {loading ? (
              ...
              {sidebarOpen ? (
                <div className="hidden sm:flex sm:flex-1 min-h-0">
                  ...
                  <Allotment.Pane minSize={180} preferredSize={260} snap>
                    <aside className="flex h-full border-r border-[#51412c] flex-col bg-[#362712]">
                      <div className="px-3 pt-2.5 pb-1 text-[10.5px] uppercase tracking-[0.16em] text-[#a57a4c]">
                        Files
                      </div>
                  ...
                  <Allotment.Pane minSize={360}>
                    <div className="h-full min-w-0 overflow-hidden bg-[#221a0f]" data-lenis-prevent>
                      {loading ? (
                        <div className="flex h-full items-center justify-center p-4">
                          <DinoLoader compact />
                        </div>
                ...
                <div className="hidden sm:flex sm:flex-1 min-w-0 overflow-hidden bg-[#221a0f]" data-lenis-prevent>
                  {loading ? (
                    <div className="flex h-full items-center justify-center p-4">
                      <DinoLoader compact />
                    </div>
