...
export const SkewFillButton = createAnimatedButton({
  ...
  renderContent: ({ formattedChildren, appearance }) => (
    <>
      <span
        className={cn(
          'pointer-events-none absolute inset-y-0 left-0 w-full origin-left -skew-x-12 scale-x-0 transition-transform duration-500 ease-[cubic-bezier(0.65,0,0.35,1)] group-hover:scale-x-100',
