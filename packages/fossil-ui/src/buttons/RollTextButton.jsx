...
export const RollTextButton = createAnimatedButton({
  ...
  renderContent: ({ label }) => (
    <>
      ...
      <span className="absolute inset-x-0 top-0 flex w-full flex-col transition-transform duration-500 ease-[cubic-bezier(0.76,0,0.24,1)] group-hover:-translate-y-[var(--fossil-btn-h)]">
